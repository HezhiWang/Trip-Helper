    ...
    try:
        ...
        for i, item in enumerate(recommended_center):
            ...
            for x in index_list[recommendation_order[i]]:
                f.write(r'\b {} \b0 \line\ '.format(recommended_attraction.iloc[x]['name']))
            ...
            for x in range(2):
                f.write(r'\b {} \b0 \line\ '.format(recommended_hotel.iloc[x]['Name']))
            ...
            for x in range(3):
                ...
                f.write(r'\b {} \b0 \line\ '.format(recommended_restaurant.iloc[x]['Name']))
